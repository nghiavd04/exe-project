...
public interface NotificationService {
    ...
    void createTargetedNotification(String title, String content, String targetEmail, SubscriptionTier targetPlanTier);
    List<NotificationResponse> getNotificationsForUser(Long userId);
    void markAsRead(Long notificationId, Long userId);
    void markAllAsRead(Long userId);
    long getUnreadCount(Long userId);

    Page<AdminNotificationResponse> getSentNotifications(Pageable pageable);
}
